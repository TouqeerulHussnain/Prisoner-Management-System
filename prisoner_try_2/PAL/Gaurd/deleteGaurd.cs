...
{
    public partial class deleteGaurd : Form
    {
        public deleteGaurd()
        {
            InitializeComponent();
        ...
        private void cmbGuard_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void deleteGaurd_Load(object sender, EventArgs e)
        {
        ...
        private void btnAddJailer_Click(object sender, EventArgs e)
        {
            ...
            GuardDataAccess.DeleteRecord(id);
        }
    }
}
